...
const Header = ({ authLogout }: Props) => {
  ...
  return (
    <div
      ...
      className="navbar navbarHorizontal navbar-expand-md navbar-light navbar-static "
    >
      <div
        id="paymentCountDown"
      ...
      <div className="leftSide">
        <a href="http://local.mlm/user/dashboard">
          <img height="72" src="/assets/images/logo.png" alt="logo" />
        </a>
      </div>
      <div
        ...
        <div className="dropdown   ml-2 ml-md-4">
          ...
          >
            ...
            >
              ...
              <span className="nav-link-text text-dark pl-4">Log out</span>
            </a>
          </div>
        </div>
      </div>
