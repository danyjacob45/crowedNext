      ...
      <div className="home">
        ...
        <Element name="BUSINESS_MODEL" className="BUSINESS_MODEL">
          <div className="container">
                    ...
                    <div className="row  h-100">
                      <div className="col-12  h-50  ">
                        <div
                          ...
                          className="greenBox p-3 mb-3 text-center"
                        >
            ...
            <div className="row mt-5 pt-5">
              ...
              <div className="col-12 col-md-6">
                <span style={{ color: "#2ea031" }}>Our solution:</span>
                <div className="mt-3">
        ...
        <Element name="lifCircle" className="lifCircle">
          <div className="container">
            ...
            <div className="row d-flex strategyCrdWrapper mt-5 pt-3  ">
        ...
        >
          ...
          <div className="text-center controllers">
            ...
            >
              ...
              >
                <path
                  fill={roadPosition === 0 ? "grey" : "#2ea031"}
            ...
            >
              ...
              >
                <path
                  fill={roadPosition === 2 ? "grey" : "#2ea031"}
          ...
          <div style={{ color: "#fff" }} className="newRoadMap mt-5 pb-5">
            <div className="roadYarBg">
              {roadPosition === 1 ? 2020 : roadPosition === 0 ? 2017 : 2024}
            </div>
            <img
